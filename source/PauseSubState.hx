...
class PauseSubState extends MusicBeatSubstate
{
	...
	var menuItems:Array<String> = ['Resume', 'Restart Song', 'Restart Song with Dialogue', 'Exit to menu'];
		...
		}else if (downP)
		{
			...
			else if (leftP)
			{
				...
				if(!offsetChanged)
				{
					...
					menuItems = ['Resume','Restart Song', 'Restart Song with Dialogue', 'Exit to menu'];
		...
		if (accepted)
		{
			...
			switch (daSelected)
			{
				...
				case "Restart Song":
					...
					FlxG.resetState();
				case "Restart Song with Dialogue":
